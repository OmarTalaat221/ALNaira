...
const AllStudentsQueries = () => {
  document.title = "All Students Queries | ALNaierh  ";
  ...
  const getCourseQueries = () => {
    ...
    axios
      .post(
        base_url +
          "/admin/student_question/select_student_questions_not_answerd.php",
