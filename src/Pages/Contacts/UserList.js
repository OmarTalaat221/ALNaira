...
const UserList = () => {
  document.title = "User List | ALNaierh  ";
      ...
      >
        ...
        <div className="modal-body">
          <Row>
            <Col md={6}>
              <div className="mb-3">
                <label className="form-label" htmlFor="AddNew-Username">
                  Username
                </label>
                <input
                  type="text"
            ...
            <Col md={6}>
              <div className="mb-3">
                <label className="form-label" htmlFor="AddNew-Email">
                  Email
                </label>
                <input
                  type="text"
            ...
            <Col md={6}>
              <div className="mb-3">
                <label className="form-label" htmlFor="AddNew-Phone">
                  Phone
                </label>
                <input
                  type="text"
