   ...
   */
    ...
    const getuniversits = () => {
      const data_send={
        ...
        axios.post(base_url+"/admin/universities/select_university.php",JSON.stringify(data_send))
            .then((res) => {
                console.log(res);
    ...
    const addCourse = async (e) => {
        ...
        if (Object.values(data_send).every(value => value !== undefined && value !== null && value !== "")) {
            const url = await axios.post(base_url+"/admin/courses/add_course.php", JSON.stringify(data_send));
            console.log(url)
