...
const AddCourse = () => {
  ...
  const getuniversits = () => {
    axios
      .get(
        "https://camp-coding.online/Teacher_App_2025/elnaira_jor/admin/universities/select_university.php"
      )
      .then((res) => {
        console.log(res);
  ...
  const addCourse = async (e) => {
    ...
    if (
      ...
      const url = await axios.post(
        "https://camp-coding.online/Teacher_App_2025/elnaira_jor/admin/courses/add_course.php",
