                ...
                <div className="">
                    ...
                    <div className="d-flex justify-content-between align-items-center">
                      ...
                      <div>
                        <span className="badge badge-soft-primary">
                          25.4%<i className="mdi mdi-arrow-down ms-2"></i>
                        </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mt-3 border-top pt-3">
                    <div className="d-flex justify-content-between align-items-center">
                      ...
                      <div>
                        <span className="badge badge-soft-primary">
                          17.4%<i className="mdi mdi-arrow-down ms-2"></i>
                        </span>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="d-flex justify-content-between align-items-center">
                      ...
                      <div>
                        <span className="badge badge-soft-success">
                          16.3%<i className="mdi mdi-arrow-up ms-1"></i>
                        </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mt-3 border-top pt-3">
                    <div className="d-flex justify-content-between align-items-center">
                      ...
                      <div>
                        <span className="badge badge-soft-primary">
                          65.7%<i className="mdi mdi-arrow-up ms-1"></i>
                        </span>
                      </div>
                    </div>
                  </div>
