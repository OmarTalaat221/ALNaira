...
const AdvancedPlugins = () => {
  document.title = "Advanced Plugins | ALNaierh  ";
            ...
            <Col lg={12}>
              <Card>
                <CardHeader>
                  ...
                  <p className="card-title-desc">
                    Choices is a lightweight, configurable select box/text input
                    plugin.
                  </p>
                </CardHeader>
                <CardBody>
            ...
            <Col lg={12}>
              <Card>
                <CardHeader>
                  ...
                  <p className="card-title-desc">
                    Fancy and customizable colorpicker plugin for React
                    Colorpicker.
                  </p>
                </CardHeader>
                <CardBody>
