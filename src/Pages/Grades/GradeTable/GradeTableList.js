...
const UnitListTable = ({grades, universitydata, showHideUnit,updatedata}) => {
    ...
    const handleupdateshowhid=(data)=>{
      ...
      axios.post(base_url+"/admin/universities/update_grade_hidden.php",JSON.stringify(data_send))
      .then((res)=>{
    ...
    const handleOk = async (e) => {
      ...
      const units = await axios.post(base_url+"/admin/universities/update_grade.php", send_data);
      // console.log(units);
