...
const Ebooks = ({ CourseId, unitId, allunitdata, cd }) => {
  ...
  const getEbooks = async () => {
    ...
    const get = await axios.post(
      "https://camp-coding.online/Teacher_App_2025/elnaira_jor/admin/ebooks/select_ebook.php",
      data_send
    );
  ...
  const showHideEbooks = async (send_data) => {
    const ebooks_1 = await axios.post(
      "https://camp-coding.online/Teacher_App_2025/elnaira_jor/admin/ebooks/update_ebook_hidden.php",
      send_data
    );
  ...
  const editEbook = async (e) => {
    ...
    const edit = await axios.post(
      "https://camp-coding.online/Teacher_App_2025/elnaira_jor/admin/ebooks/update_ebook_info.php",
      data_send
    );
  ...
  const handlecopyitem = (data) => {
    ...
    axios
      .post(
        "https://camp-coding.online/Teacher_App_2025/elnaira_jor/admin/ebooks/make_copy_from_ebooks.php",
  ...
  const addBook = async (e) => {
    ...
    // https://camp-coding.online/Teacher_App_2025/elnaira_jor/admin/ebooks/insert_ebooks.php
