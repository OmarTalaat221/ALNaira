...
const MCQTableList = ({ video_id, self }) => {
    ...
    const getQuestions = async () => {
        ...
        const mcqs = await axios.post("https://elmatary.com/El_Matary_Platform/platform/admin/videos/select_video_data.php", { video_id: video_id });
        console.log(mcqs);
    ...
    const changeStatus = async () => {
        console.log(item);
        await axios.post("https://elmatary.com/El_Matary_Platform/platform/admin/Exams/update_ques_hidden.php", {
    ...
    const uploadFile = async () => {
        ...
        if (image) {
            ...
            const url = await axios.post("https://elmatary.com/El_Matary_Platform/platform/admin/image_uplouder.php", formData);
            console.log(url);
            if (url && url?.length) {
