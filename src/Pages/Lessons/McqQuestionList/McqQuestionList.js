          ...
          <>
            <button
              onClick={() => {
                ...
                setIsModalOpen(true);
                let alldatapushed = [];
                // setallanswers([...cell.cell.row.original.question_answers]);
                for (
                  let i = 0;
            ...
            <button
              onClick={() => {
                if (
                  ...
                  axios
                    .post(
                      "https://camp-coding.online/Teacher_App_2025/elnaira_jor/admin/Exams/delete_question.php",
                      {
                        question_id: cell.cell.row.original?.question_id,
                      }
                    )
                    .then((res) => {
                      updatemcq();
              ...
              </label>
              {
                answerlist?.map((item,index)=>{
                  return(
                    ...
                    }} checked={item.answer_check=="true"} type="checkbox" name="" id="" />
                    </div>
                  )
                })
              }
