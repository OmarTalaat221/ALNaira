...
const LiveQuesMcq = () => {
  ...
  const addlivequestion=()=>{
    ...
    axios.post("https://elmatary.com/El_Matary_Platform/platform/admin/live_poll/insert_live_poll_question.php",JSON.stringify(data_send))
    .then((res)=>{
      console.log(res)
  ...
  const getlivequestions=()=>{
    ...
    axios.post("https://elmatary.com/El_Matary_Platform/platform/admin/live_poll/select_live_poll_question.php",data_send)
    .then((res)=>{
  ...
  return (
    ...
    <div className="page-content">
      <Container fluid={true}>
        ...
        <LiveQuestionTable handleupdate={()=>{
          getlivequestions()
        }}  questions={questions} />
