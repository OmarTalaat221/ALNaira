...
const AddCourse = () => {
   ...
   */
    ...
    const getuniversits=()=>{
      axios.get("https://elmatary.com/El_Matary_Platform/platform/admin/universities/select_university.php")
      .then((res)=>{
        console.log(res);
    ...
    const addCourse = async (e) => {
        ...
        const url = await axios.post("https://elmatary.com/El_Matary_Platform/platform/admin/courses/add_course.php", JSON.stringify(data_send));
        console.log(url)
