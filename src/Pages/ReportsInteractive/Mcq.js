            ...
            <>
              <UncontrolledDropdown>
                ...
                <DropdownMenu className="dropdown-menu-end">
                  ...
                  <DropdownItem onClick={() => {
                    setrowdata({...rowdata,question_id:cell.cell.row.original.report_item_data.question_id});
                    ...
                    for(let i=0 ;i<cell.cell.row.original?.report_item_data?.answers?.length;i++){
                  let obj={
                    id:i+1,
                    answer:cell.cell.row.original?.report_item_data?.answers[i].answer_value,
                    checked:cell.cell.row.original?.report_item_data?.answers[i].answer_score=="true"?true:false,
                  }
                  // console.log(cell.cell.row.original?.answers)
            ...
            <Card>
              <CardBody>
                ...
                <div id="table-invoices-list">{itemLoader ? <Loader /> : <>
                  {itemReport && itemReport.length>0 ? <FlashCardsTableList showHideFlashCard={showHideFlashCards} data={itemReport} columns={columns} /> : <h4>No Reports</h4>}
                </>}</div>
              </CardBody>
            </Card>
          </Col>
            ...
            <Row>
              <Col md={12}>
                <div className="mb-3">
                  ...
                  <textarea className="form-control" defaultValue={item?.question_text} onChange={(e) => setSide3(e.currentTarget.value)} name="" id="" cols="30" rows="10"></textarea>
