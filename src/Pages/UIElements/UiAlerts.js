...
const UiAlerts = () => {
  document.title = "Alerts | ALNaierh  ";
            ...
            <Col xl={6}>
              <Card>
                <CardHeader>
                  ...
                  <p className="card-title-desc">
                    You can use flexbox utilities and Icons to create alerts
                    with icons
                  </p>
                </CardHeader>
            ...
            <Col xl={6}>
              <Card>
                ...
                <CardBody>
                  <UncontrolledAlert
                    color="success"
                    className="alert alert-border-left"
                  >
              ...
              <Card>
                ...
                <CardBody>
                  ...
                  >
                    ...
                    <strong style={{ marginLeft: "40px" }}>Success</strong> -
                  ...
                  >
                    ...
                    <strong style={{ marginLeft: "40px" }}>Danger</strong> -
                    Label icon arrow alert
                  </UncontrolledAlert>
                  <UncontrolledAlert
                    color="warning"
                  ...
                  >
                    ...
                    <strong style={{ marginLeft: "40px" }}>Warning</strong> -
                    Label icon arrow alert
                  </UncontrolledAlert>
                  <UncontrolledAlert
                    color="info"
                  ...
                  >
                    ...
                    <strong style={{ marginLeft: "40px" }}>Info</strong> - Label
                    icon arrow alert
                  </UncontrolledAlert>
                </CardBody>
              </Card>
            ...
            <Col xl={12}>
              <Card>
                <CardHeader>
                  ...
                  <p className="card-title-desc">
                    Success, Error and Warning Alert Examples.
                  </p>
                </CardHeader>
