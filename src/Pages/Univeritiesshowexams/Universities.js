...
const Universities = () => {
    ...
    const getUniversities = async () => {
        setItemLoader(true);
        const University = await axios.get("https://elmatary.com/El_Matary_Platform/platform/admin/universities/select_university.php");
    ...
    const showHideCourse = async (send_data) => {
        const courses = await axios.post("https://elmatary.com/El_Matary_Platform/platform/admin/courses/show_hide_course.php", JSON.stringify(send_data));
        // console.log(courses);
        if (courses.status) {
