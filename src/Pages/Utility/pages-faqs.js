                ...
                <CardBody>
                  ...
                  <Row className="mt-5">
                    ...
                    <Col xl={8}>
                      <div
                        id="faqs-accordion"
                        className="custom-accordion mt-5 mt-xl-0"
                      >
                        <Card className="border shadow-none">
                          <Link
                            to="#faqs-gen-ques-collapse"
                            aria-haspopup={true}
                            aria-expanded={true}
                          ...
                          <Collapse isOpen={col1} id="faqs-gen-ques-collapse">
                            <div className="p-4">
                              <Row>
                                <Col md={6}>
                                  <div>
                                    <div className="d-flex align-items-start mt-4">
                                      <div className="flex-shrink-0 me-3">
                                        <h5 className="text-primary font-size-16">
                                          01.
                                        </h5>
                                      </div>
                        ...
                        <div className="card border shadow-none">
                          <Link
                            to="#faqs-privacy-policy-collapse"
                            aria-haspopup={true}
                            aria-expanded={false}
                        ...
                        <div className="card border shadow-none">
                          <Link
                            to="#faqs-pricing-plans-collapse"
                            aria-haspopup={true}
                            aria-expanded={false}
