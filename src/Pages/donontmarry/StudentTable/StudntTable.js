...
const StudntListTable = ({ getStudents, Units, courseData, showHideUnit }) => {
  ...
  const changeSerial = async () => {
    const new_serial = await axios.post(
      "https://camp-coding.online/Teacher_App_2025/elnaira_jor/admin/students/update_serial_num_empty.php",
  ...
  const changeBlock = async (id, value) => {
    ...
    const blocked = await axios.post(
      "https://camp-coding.online/Teacher_App_2025/elnaira_jor/admin/students/update_ban_student.php",
  ...
  const changeSimCard = async (id, value) => {
    ...
    const simCard = await axios.post(
      "https://camp-coding.online/Teacher_App_2025/elnaira_jor/admin/students/update_sim_card.php",
      { student_id: id, status: value }
    );
  ...
  const changeHeadPhone = async (id, value) => {
    ...
    const headPhone = await axios.post(
      "https://camp-coding.online/Teacher_App_2025/elnaira_jor/admin/students/update_head_phone_jack.php",
      { student_id: id, status: value }
    );
  ...
  return (
    <React.Fragment>
      ...
      <Modal title="Un Assign Student" isOpen={showUnAssign}>
        <form
          action="#"
          style={{
            padding: "15px",
