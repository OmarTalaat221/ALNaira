...
const CallCenter = () => {
    ...
    const getUnits = async () => {
        ...
        try {
            const units = await axios.get("https://elmatary.com/El_Matary_Platform/platform/user/home/setting/select_call_center.php");
    ...
    const handleOk = async (e) => {
        ...
        const units = await axios.post("https://elmatary.com/El_Matary_Platform/platform/admin/info/add_call_center.php", send_data);
    ...
    const deleteCallCenter = async (e) => {
        ...
        const units = await axios.post("https://elmatary.com/El_Matary_Platform/platform/admin/info/delete_call_center_item.php", { id: rowdata?.id });
        console.log(units);
        if (units.status == "success") {
